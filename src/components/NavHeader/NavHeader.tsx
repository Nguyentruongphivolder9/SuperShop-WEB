...
export default function NavHeader() {
  ...
  return (
    <div className='flex justify-end ml-auto space-x-4'>
      <Popover className='flex cursor-pointer items-center py-1 hover:text-white/70' renderPopover={<div className='relative rounded-sm border border-gray-200 bg-white shadow-md'> <div className='flex flex-col '> <button className='text-sm py-2 pl-6 pr-32 text-left hover:text-orange'>Tiếng Việt</button> <button className='text-sm mt-2 py-2 pl-6 pr-32 text-left hover:text-orange'>English</button> </div> </div>} >
        <svg
