...
export default function ProductEdit() {
  ...
  const [isSaveAndDelist, setIsSaveAndDelist] = useState<boolean>(false)
      ...
      <div className='grid grid-cols-11 gap-4'>
        <FormProvider {...productEditMethods}>
          <form className='col-span-9'>
            ...
            {isSaveAndDelist && (
              <ContainerModal>
                <div className='w-[400px] relative bg-white border-dashed border-[1px] border-blue rounded-md shadow h-auto'>
                  <div className='flex flex-col'>
                  ...
                  <button
                    onClick={() => setIsSaveAndDelist(false)}
                    type='button'
                    className='text-[#999999] h-6 p-1 absolute right-3 top-1 w-6'
                  >
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      fill='none'
                ...
                <div className='w-[400px] relative bg-white border-dashed border-[1px] border-blue rounded-md shadow h-auto'>
                  <div className='flex flex-col'>
                    ...
                    <div className='p-6 flex flex-row justify-end gap-2'>
                      <button
                        type='button'
                        onClick={() => setIsSaveAndPublish(false)}
                        className={`text-sm border border-solid border-gray-300 rounded-md px-4 py-2 text-[#333333]`}
                      >
                        Optimize Now
                      </button>
